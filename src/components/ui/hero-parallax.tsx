...
export const HeroParallax = ({
  ...
  return (
    <div ref={ref} className="h-[300vh] pt-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]">
      <Header />
      <motion.div
        style={{
          rotateX,
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white text-white">madebyajung</h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200 text-neutral-200">
        Strong design. Sharp code.
        <br />
        madebyajung is where brands level up.
      </p>
    </div>
  );
};
