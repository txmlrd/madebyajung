...
export const Navbar = ({ children, className, onScrolling }: NavbarProps) => {
...
export const NavbarLogo = ({visible} : {visible?: boolean}) => {
  return (
    <a href="#" className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black">
      {visible ? (
        <div className="flex h-10 w-10 items-center justify-center rounded-md p-1 bg-black/10 dark:bg-white/10">
          <img src="/logos/mba-light.svg" alt="logo" width={30} height={30} />
        </div>
      ) : (
        <div className="flex h-10 w-10 items-center justify-center rounded-md p-1 bg-black/10 dark:bg-white/10">
          <img src="/logos/mba-light.svg" alt="logo" width={30} height={30} />
      ...
      <span className="font-medium text-black dark:text-white">madebyajung</span>
    </a>
  );
};
