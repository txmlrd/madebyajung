  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">Built and launched Starter Academy's website with my team for 2023 PKM-K output purpose.</p>
          <p className="text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">Successfully delivered the project on time and received positive feedback from stakeholders.</p>
        </div>
      ),
    },
    {
